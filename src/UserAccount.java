...
class Transactions{
    ...
    Transactions(String transaction_type,String userid,String holder_name,long amount,Date date){
...
class UserAccount extends Account {
    ...
    static ArrayList<Transactions> total_transactions=new ArrayList<Transactions>();
        ...
        while(true) {
            ...
            //if customer choses normal cash
                ...
                if (this.balance >= amount && this.withDrawn + amount <= limit) {
                    ...
                    System.out.println("Successfully Withdrawn");
                    this.receipt(amount,"Withdrawn");
                    total_transactions.add(new Transactions("Cash Withdrawal",this.userId,this.name,amount,new Date()));
                    return;
                }
                System.out.println("Unfortunately either you have less balance or have reached your limit");
                return;
    ...
    public void deposit(){
        while(true) {
            ...
            if(amount>0){
                ...
                total_transactions.add(new Transactions("Cash Deposited",this.userId,this.name,amount,new Date()));
                return;
            }
    ...
    public void cashTransfer(ArrayList<UserAccount> accounts){
        ...
        outer: while(true) {
            ...
            if(acc_no==object_acc.accunt_number){
                ...
                total_transactions.add(new Transactions("Cash Transfered",this.userId,this.name,amount,new Date()));
                return;
            }
            else {
